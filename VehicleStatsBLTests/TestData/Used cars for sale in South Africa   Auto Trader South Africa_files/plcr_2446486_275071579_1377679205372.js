              ...
              function PlacementCreative_1377679203636(creative) {
                ...
                this.exitEvents["ApplyNow_Clickthrough"] = {
                    reportingId: 871056,
                    url: this.replaceMacros("https://www.wesbank.co.za/wesbankcoza/campaigns/privatefinance/index.xhtml", creative),
                ...
                this.counterEvents["Caculate Button"] = {
                    reportingId: 871365,
                    sourceComponentName: "",
                    sourceStandardEventId: "-1"
                };
                this.counterEvents["Reset Button"] = {
                    reportingId: 871366,
                    sourceComponentName: "",
                    sourceStandardEventId: "-1"
                };
                this.counterEvents["Baloon Payment ? Button"] = {
                    reportingId: 871369,
                    sourceComponentName: "",
                    sourceStandardEventId: "-1"
                };
                this.counterEvents["Baloon Percentage ? Button"] = {
                    reportingId: 871363,
                    sourceComponentName: "",
                    sourceStandardEventId: "-1"
                };
                this.counterEvents["Deposit Input Text Field"] = {
                    reportingId: 871360,
                    sourceComponentName: "",
                    sourceStandardEventId: "-1"
                };
                this.counterEvents["Baloon Percentage Dropdown"] = {
                    reportingId: 871368,
                    sourceComponentName: "",
                    sourceStandardEventId: "-1"
                };
                this.counterEvents["Price Input Text Field"] = {
                    reportingId: 871362,
                    sourceComponentName: "",
                    sourceStandardEventId: "-1"
                };
                this.counterEvents["Repayment Term Dropdown"] = {
                    reportingId: 871367,
                    sourceComponentName: "",
                    sourceStandardEventId: "-1"
                };
                this.counterEvents["Deposit ? Button"] = {
                    reportingId: 871371,
                    sourceComponentName: "",
                    sourceStandardEventId: "-1"
                };
                this.counterEvents["Price ? Button"] = {
                    reportingId: 871364,
                    sourceComponentName: "",
                    sourceStandardEventId: "-1"
                };
                this.counterEvents["Term ? Button"] = {
                    reportingId: 871361,
                    sourceComponentName: "",
                    sourceStandardEventId: "-1"
                };
                this.counterEvents["Interest Rate ? Button"] = {
                    reportingId: 871370,
                    sourceComponentName: "",
                    sourceStandardEventId: "-1"
                };
                ...
                this.childAssets = new Object();
                  this.childAssets["WesbankCalculator_CHILD_160x600.swf"] = {
                    isHostedByCdn: false,
                    cdnName: "PID_2446486_WesbankCalculator_CHILD_160x600.swf",
                    isVideo: false,
                    streamingUrl: "",
                    progressiveUrl: "",
                ...
                for(var assetName in this.childAssets) {
                  if (!core.isPartOfArrayPrototype(assetName)) {
                    ...
                    if(!asset.isHostedByCdn) {
                      var fileUrl = creative.mediaServer + "/2589528/" + asset.cdnName;
               ...
               function InPage_1377679203636(creative, type) {
                  this.variableName = "0_1_" + (new Date()).getTime();
                  this.url = creative.mediaServer + "/2589528/PID_2446486_WesbankCalculator_POLITE_160x600.swf";
                  this.altText = "";
                  this.width = "160";
                  this.height = "600";
                  this.wmode = "Opaque";
              ...
              function InPageHTML_1377679203636(creative, type) {
                  this.variableName = "0__" + (new Date()).getTime();
                  this.url = creative.mediaServer + "/2589528/";
                  this.altText = "";
                  this.width = "";
                  this.height = "";
                  this.assetType = type;
              ...
              var baseCreative = new RichMediaCreative_1377679203636(core.CREATIVE_TYPE_INPAGE);
              var creative = new PlacementCreative_1377679203636(baseCreative);
              var isFlashAssetExist = true;
              if(creative.shouldDisplayFlashAsset) {
                creative.assets[core.ASSET_TYPE_INPAGE] = new InPage_1377679203636(creative, core.ASSET_TYPE_INPAGE);
              ...
              if(creative.forceHTML5Creative || creative.isHTML5PreviewMode || !creative.shouldDisplayFlashAsset || !isFlashAssetExist) {
                ...
                creative.assets[core.ASSET_TYPE_INPAGE] = new InPageHTML_1377679203636(creative, core.ASSET_TYPE_INPAGE);
              }
